...
public class MonitorEngine extends Monitor {
	
	public static String ID = "Monitor motor";

	public MonitorEngine(BundleContext context) {
		super(context, ID);
	}
	...
	public IMonitor report(Object measure) {
		...
		try {
			...
			IKnowledgeProperty kp = BasicMAPEKLiteLoopHelper.getKnowledgeProperty("Motor");
