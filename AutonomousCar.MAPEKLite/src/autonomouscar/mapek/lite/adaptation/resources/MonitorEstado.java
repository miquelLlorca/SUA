...
public class MonitorEstado extends Monitor {
	
	public static String ID = "Monitor Estado Carretera";

	public MonitorEstado(BundleContext context) {
		super(context, ID);
	}
	...
	public IMonitor report(Object measure) {
		...
		try {
			...
			IKnowledgeProperty kp = BasicMAPEKLiteLoopHelper.getKnowledgeProperty("Estado_Carretera");
