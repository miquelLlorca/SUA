...
public class MonitorTipo extends Monitor {
	
	public static String ID = "Monitor Tipo Carretera";

	public MonitorTipo(BundleContext context) {
		super(context, ID);
	}
	...
	public IMonitor report(Object measure) {
		...
		try {
			...
			IKnowledgeProperty kp = BasicMAPEKLiteLoopHelper.getKnowledgeProperty("Tipo_Carretera");
