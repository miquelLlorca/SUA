...
public class MonitorDriver extends Monitor {
	
	public static String ID = "Monitor_Conductor";

	public MonitorDriver(BundleContext context) {
		super(context, ID);
	}
	...
	public IMonitor report(Object measure) {
		...
		try {
			...
			IKnowledgeProperty kp = BasicMAPEKLiteLoopHelper.getKnowledgeProperty("Humano");
