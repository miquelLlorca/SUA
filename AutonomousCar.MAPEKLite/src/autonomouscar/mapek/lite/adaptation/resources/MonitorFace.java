...
public class MonitorFace extends Monitor {
	
	public static String ID = "Monitor_Manos";

	public MonitorFace(BundleContext context) {
		super(context, ID);
	}
	...
	public IMonitor report(Object measure) {
		...
		try {
			...
			IKnowledgeProperty kp = BasicMAPEKLiteLoopHelper.getKnowledgeProperty("Cara");
