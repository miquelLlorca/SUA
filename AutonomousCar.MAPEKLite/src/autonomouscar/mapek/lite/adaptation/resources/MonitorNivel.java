...
public class MonitorNivel extends Monitor {
	
	public static String ID = "Monitor Nivel conduccion";

	public MonitorNivel(BundleContext context) {
		super(context, ID);
	}
	...
	public IMonitor report(Object measure) {
		...
		try {
			...
			IKnowledgeProperty kp = BasicMAPEKLiteLoopHelper.getKnowledgeProperty("Nivel_Conduccion");
