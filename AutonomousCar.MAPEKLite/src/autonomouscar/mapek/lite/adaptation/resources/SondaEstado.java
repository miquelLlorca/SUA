...
public class SondaEstado extends Probe implements ServiceListener{
	
	public static String ID = "Sonda Estado Carretera";

	public SondaEstado(BundleContext context) {
		super(context, ID);
		MonitorEstado m = new MonitorEstado(context);
	...
	public void serviceChanged(ServiceEvent event) {
		...
		this.reportarMedicion(r.getRoadStatus().name());
	}
